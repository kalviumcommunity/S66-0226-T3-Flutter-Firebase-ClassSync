...
/// AuthScreen — demonstrates Firebase Authentication.
///
/// Features:
///  - Toggle between Sign Up and Sign In modes
///  - Real-time auth state via StreamBuilder (shows logged-in card automatically)
///  - Human-readable Firebase error messages
///  - Loading state during async auth calls
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: const [
            ...
            Text('Email/Password Authentication Demo',
    ...
    return Column(
      ...
      children: [
        ...
        _ConceptBanner(
          ...
          color: Colors.blue,
          text: 'Firebase persists this session automatically. '
